...
#Tax
```{r taxa}
ps_clr_corrected <- readRDS("/fast/AG_Forslund/Lola/Secuencias_INCLIVA_2024/MHE_rif/outputs/merged/ps_met_corrected.Rds")

input_data <- data.frame(otu_table(ps_clr_corrected))
input_metadata <-data.frame(sample_data(ps_clr_corrected))

output_dir <- "/fast/AG_Forslund/Lola/Secuencias_INCLIVA_2024/MHE_rif/outputs/merged/Figures_merged/MaAsLin2/Taxa_all_metaphlan"
