...
OUTDIR="${OUTDIR:-/fast/AG_Forslund/Lola/Secuencias_INCLIVA_2024/Assembly/Segatella_copri/results/Responders}"
THREADS="${SLURM_CPUS_PER_TASK}"

mkdir -p "$OUTDIR"

# Read sample names from the Responders.txt file
SAMPLES=($(cat /fast/AG_Forslund/Lola/Secuencias_INCLIVA_2024/Assembly/Responders.txt))
