...
# Round
fpkm_Spain[, sample_cols] <- round(fpkm_Spain[, sample_cols], 1)
...
fpkm_UK[, sample_cols_UK] <- round(fpkm_UK[, sample_cols_UK], 1)
...
# Optional: round for readability
fpkm_Spain_ResFinder[, sample_cols] <- round(fpkm_Spain_ResFinder[, sample_cols], 1)
...
# Optional: round for readability
fpkm_UK_ResFinder[, sample_cols_UK] <- round(fpkm_UK_ResFinder[, sample_cols_UK], 1)
...
saveRDS(ARGs_ResFinder, file = "/fast/AG_Forslund/Lola/Secuencias_INCLIVA_2024/Secuences_bibliography/Patel_analysis/outputs/ARGs_ResFinder.Rds")
