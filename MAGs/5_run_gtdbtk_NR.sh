...
MAGS_DIR_NR="${BASE_DIR}/Segatella_copri/scripts/test_out/NR/bins"
OUTDIR="${BASE_DIR}/Segatella_copri/results/gtdbtk/NR"
...
gtdbtk classify_wf \
    --genome_dir "$MAGS_DIR_NR" \
    --extension fa.gz \
    --out_dir "$OUTDIR" \
    --cpus "$SLURM_CPUS_PER_TASK" \
    --skip_ani_screen

echo "GTDB-Tk NR finished"
