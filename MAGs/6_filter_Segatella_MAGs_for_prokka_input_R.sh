...
GTDB_SUMMARY="${BASE_DIR}/Segatella_copri/results/gtdbtk/R/gtdbtk.bac120.summary.tsv"
BINS_DIR="${BASE_DIR}/Segatella_copri/scripts/test_out/R/bins"
OUT_DIR="${BASE_DIR}/Segatella_copri/MAGs/Prevotella_copri/R"
