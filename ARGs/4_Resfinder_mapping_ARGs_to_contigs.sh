...
THREADS=4
IDX_DIR="/fast/AG_Forslund/Lola/Secuencias_INCLIVA_2024/Assembly/bowtie_indexes_per_sample_resfinder"
INDIR="/fast/AG_Forslund/Lola/Secuencias_INCLIVA_2024/outputs"
OUTDIR="/fast/AG_Forslund/Lola/Secuencias_INCLIVA_2024/Assembly/bowtie_out_Resfinder"
mkdir -p "$OUTDIR"
