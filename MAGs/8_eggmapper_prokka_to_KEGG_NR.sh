...
# Paths
# =====================
PROKKA_OUT="/fast/AG_Forslund/Lola/Secuencias_INCLIVA_2024/Assembly/Segatella_copri/results/prokka/NR"
EGGNOG_OUT="/fast/AG_Forslund/Lola/Secuencias_INCLIVA_2024/Assembly/Segatella_copri/results/eggnog_mapper/NR"
