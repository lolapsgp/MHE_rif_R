...
#SBATCH --array=1-23  # adjust to number of samples
...
NAMES_FILE="${NAMES_FILE:-/fast/AG_Forslund/Lola/Secuencias_INCLIVA_2024/Assembly/NonR.txt}"
...
samtools index -@ "$THREADS" "${OUT_BAM_DIR}/${sample}.sorted.bam"f
